...
export function translateChatMessage(
    ...
    switch (message.type) {
        ...
        case "alienResult":
            return translate("chatMessage.alienResult", playerListToString(message.sieve, playerNames));
        case "alienProbabilities":
            return translate("chatMessage.alienProbabilities", Math.round(message.enemyFilterProbability / 255 * 100), Math.round(message.friendFilterProbability / 255 * 100));
        case "lookoutResult":
