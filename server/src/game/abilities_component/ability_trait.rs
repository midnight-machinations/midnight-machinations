...
pub trait AbilityTrait {
    fn on_midnight(&self, _game: &mut Game, _id: &AbilityID, __event: &OnMidnight, _midnight_variables: &mut MidnightVariables, _priority: OnMidnightPriority) {}
    ...
    fn on_player_roleblocked(&self, _game: &mut Game, _id: &AbilityID, _event: &OnPlayerRoleblocked, _fold: &mut MidnightVariables, _priority: ()) {}
    fn on_visit_wardblocked(&self, _game: &mut Game, _id: &AbilityID, _event: &OnVisitWardblocked, _fold: &mut MidnightVariables, _priority: ()) {}
