...
use crate::{game::{
    ...
    }, game_conclusion::GameConclusion, player::PlayerReference, role::Role, role_list::TemplateSet, Game
}, vec_set::VecSet};
...
impl MafiaRecruits{
    ...
    fn attack_players(game: &mut Game, midnight_variables: &mut MidnightVariables, players: Vec<PlayerReference>, attack_power: AttackPower){
        ...
        for player in players{
            player.try_night_kill(&recruiters, game, midnight_variables, GraveKiller::RoleSet(TemplateSet::Mafia), attack_power, false);
        }
    }
