// use crate::{
//     game::{
//         attack_power::AttackPower, components::graves::grave::GraveKiller, controllers::*, event::{before_phase_end::BeforePhaseEnd, on_midnight::{MidnightVariables, OnMidnight, OnMidnightPriority}}, game_conclusion::GameConclusion, phase::PhaseType, player::PlayerReference, role::Role, role_list::RoleSet, Game
//     },
...
//         if event.phase == PhaseType::Night {
